...
public class FadenEntities {
    ...
    public static final EntityType<NPCEntity> NPC = registerEntity("npc", FabricEntityTypeBuilder.create(SpawnGroup.MISC, NPCEntity::new).dimensions(EntityDimensions.changing(0.6F, 1.8F)));
